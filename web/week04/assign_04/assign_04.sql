...
INSERT INTO person (USER_NAME, password, person_email, new_person, city, state)
VALUES ('MikeMizouski','d@tswrite88','mike@monsters.inc', True, 'Munster', 'Wisconsin');
INSERT INTO person (USER_NAME, password, person_email, new_person, city, state)
VALUES ('TomBrady','superbowls6','patriots@nfl.com', False, 'Boston', 'Massachusetts');
INSERT INTO person (USER_NAME, password, person_email, new_person, city, state)
VALUES ('DonovanMitchell','allstar#1','teamplayer@utahJazz.org', True, 'Salt Lake City', 'Utah');
INSERT INTO person (USER_NAME, password, person_email, new_person, city, state)
VALUES ('semadenipaulo','brazilsdastuff44','soccor4life@gmail.com', False, 'Sao Antonio', 'Texas');
INSERT INTO person (USER_NAME, password, person_email, new_person, city, state)
VALUES ('SatynaraynaNakkapalli','indiatechlife5','cricketisdabest@yahoo.com', True, 'Des Moines', 'Iowa');
